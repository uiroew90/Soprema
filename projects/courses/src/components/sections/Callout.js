      ...
      <div className='row'>
        <div className='col col-sm-8'>
          <div className='text-element noresize'>
            ...
            <p>
              Wählen Sie mit wenigen Klicks aus, welche Kombination aus Kursen für Sie und Ihr Unternehmen am Meisten
              Sinn machen.
            </p>
          </div>
        </div>
            ...
            <div
              ...
              <div className='push-content wysiwyg'>
                ...
                <p>
                  <a
                    className='button'
                    href='https://www.soprema.ch/files/2023-schulungsbroschuere-de_d71c998ecd7145324fe1b919058924d0.pdf'
                    target='_blank'
                    rel='noopener'>
                    Herunterladen
                  </a>
